...
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_PROP|/soc/i2c@40003000/npm1300@6b/npm_charger|current-microamp" "500000")
...
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_NODE|/alias" TRUE)
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_REG|/alias|NUM" "0")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_REG|/alias|ADDR" "")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_REG|/alias|SIZE" "")
