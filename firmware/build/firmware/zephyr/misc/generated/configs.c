...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_MAXIM_MAX32664C_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SENSOR_MAX32664C, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MAX32664C_USE_EXTERNAL_ACC, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MAX32664C_USE_STATIC_MEMORY, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MAX32664C_QUEUE_SIZE, 32);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MAX32664C_SAMPLE_BUFFER_SIZE, 64);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MAX32664C_THREAD_STACK_SIZE, 4096);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_MAX32664C_MODULE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_NINAB306, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_NINAB306_NRF52840, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CHARGER, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CHARGER_INIT_PRIORITY, 90);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MFD_NPM13XX, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MFD_NPM13XX_INIT_PRIORITY, 80);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_REGULATOR_NPM13XX, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_REGULATOR_NPM13XX_COMMON_INIT_PRIORITY, 85);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_REGULATOR_NPM13XX_INIT_PRIORITY, 86);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NPM13XX_CHARGER, 1);
